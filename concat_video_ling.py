...
input_video = "/home/thanhln/Desktop/Bechmark_BLM/Ling"
...
for camera in cameras:
    ...
    for i in range(len(pth_videos)):
        ...
        if i != len(pth_videos) - 1:
            new_pth_videos.append("black_ling.mp4")
    output_save_video_concat =  os.path.join(input_video, camera, f"Ling_{camera}.mp4")
